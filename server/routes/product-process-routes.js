...
const { addProductProcess, getProcesses, getProcessById, editProcess, makeProcessActive, deactivateProcess, makeProcessUsable, getMaterialsForProcessToAdd, getFreeProcesses, getProcessesInfo } = require("../controllers/product-process-controller")
...
router.get("/product-process-info", getProcessesInfo)
...
router.get("/free-processes", getFreeProcesses)
