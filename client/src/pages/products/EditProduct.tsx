          ...
          <div className='border border-gray-300 rounded-lg p-8 '>
            <div className='flex flex-col'>
              <div className='flex justify-between'>
                <div>
                  <img src={initialState.photo_url} style={{height: "300px", width: "350px"}} alt='product_photo' />
                </div>
                <div className='flex flex-col ml-5'>
                  <div>
                    ...
                    <Field as={TextInput}
                      ...
                      />
                      <div className='h-6'>
                        {status === 'failed' && !errors.name && <span className='text-xs text-red-500'>{message}</span> }
                  ...
                  <div className='flex'>
                    ...
                    <div className='ml-2'>
                      ...
                      <Field as={TextInput}
                        ...
                        />
                       <div className='h-6'>
                        <ErrorMessage name='mark_up' component='span' className='text-red-500 text-xs' />
                      </div> 
                    </div>
                  </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Field as={TextInput}
                      ...
                      />
                     <div className='h-4'>
                        <ErrorMessage name='photo_url' component='span' className='text-red-500 text-xs' />
                      </div> 
                  </div>
