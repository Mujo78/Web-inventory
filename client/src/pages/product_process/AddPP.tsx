      ...
      <div className="px-3 flex flex-col gap-16 h-3/4 border-gray-300 border w-3/5 rounded-lg">
        <div className="flex h-1/4 mt-6">
          <div className=" mr-1 w-3/6">
            <Progress color="green" progress={100} />
          </div>
          <div className="ml-1 w-3/6">
            <Progress color={step === 1 ? "gray" : "green"} progress={100} />
          </div>
        </div>
        <div className=" h-3/4">
          {step === 1 ? (
            <div className="flex flex-col gap-12">
              ...
              <form
                onSubmit={nextOne}
                className="flex flex-col justify-between gap-14 h-5/6"
              >
                <div>
                  <Label
                    htmlFor="name"
                    className="text-sm mx-5 mt-12 font-normal !text-gray-400"
                  >
                    (Type in unique product process name)
                  </Label>
                  <TextInput
                    autoComplete="off"
                    name="name"
                  ...
                  <div className="flex h-4 flex-col">
                    {status === "failed" && (
                      <Label
                        htmlFor="name"
                        className="text-sm mx-5 mt-1 font-normal !text-red-600"
                      >
                        {message}
                      </Label>
                    )}
