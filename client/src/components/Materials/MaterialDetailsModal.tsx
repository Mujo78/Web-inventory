...
import { getMaterial, material, resetMaterial } from '../../features/material/materialSlice'
  ...
  return (
    <Modal dismissible  show={show} onClose={onClose} className='font-Rubik'>
        ...
        <Table.Row className="bg-white divide-x dark:border-gray-700 dark:bg-gray-800">
          ...
          <Table.Cell>
            {specificMaterial.unit_of_measure}
          </Table.Cell>
        </Table.Row>
        <Table.Row className="bg-white divide-x dark:border-gray-700 dark:bg-gray-800">
          <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
